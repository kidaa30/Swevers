	...
	function getHTML5() {
		...
		if (!html5) {
			html5 = mapCache.html5 = unpack({
					...
					'figcaption[A][C]' +
					'img[A|alt|src|height|width|usemap|ismap|data-width|data-height][]' +
					...
					'input[A|type|accept|alt|autocomplete|autofocus|checked|disabled|form|formaction|formenctype|formmethod|formnovalidate|formtarget|height|list|max|maxlength|min|' +
						'multiple|pattern|placeholder|readonly|required|size|src|step|width|files|value|name|data-name][]' +
	...
	function getHTML4() {
		...
		if (!html4) {
			...
			html4 = mapCache.html4 = unpack({
				...
				'h1[E|align][#|S]' + 
				'img[E|src|alt|name|longdesc|width|height|usemap|ismap|align|border|hspace|vspace|data-width|data-height|data-href][]' + 
				...
				'sub[E][#|S]' + 
				'sup[E][#|S]' + 
				'input[E|D|type|name|value|checked|disabled|readonly|size|maxlength|src|alt|usemap|onselect|onchange|accept|align|data-name][]' + 
...
(function(tinymce) {
	...
	tinymce.create('tinymce.Editor', {
		Editor : function(id, settings) {
			...
			if (self.settings.contentStyles) self.contentStyles.push(self.settings.contentStyles);
...
(function(tinymce) {
	...
	tinymce.EditorCommands = function(editor) {
		...
		addCommands({
			...
			FormatBlockAlt : function(command, ui, value) {
